...
namespace ProyectoBeta.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        {
            var listado = CategoriasBLL.GetLista();
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,Descripcion")] Categorias categorias)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var categorias = await _context.Categorias.SingleOrDefaultAsync(m => m.CategoriaId == id);
            if (categorias == null)
            {
                return NotFound();
            }
